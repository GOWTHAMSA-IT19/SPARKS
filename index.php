...
<body >
	...
	<div id="header">
       <br>
       <h1 style=" font-family:Brush Script MT; font-size: 70px; color: #ffffcc;text-shadow: 2px 2px black;"> Sparks Foundation Internship Project </h1>
       <h2 style=" font-family:Brush Script MT; font-size: 55px;color: #ffffcc;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Basic Banking System </h2>
    </div>
        <div id="section">
            <table>
                <tr></tr>
